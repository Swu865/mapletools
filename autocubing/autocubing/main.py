...
class For_Stats:
    ...
    def parse_OCR_result(self) -> dict[str, int]:
        ...
        str_pattern_cd = r"([a-zA-Z\s]+)\s*-\s*(\d)\s*sec"                           #match skill cooldown
